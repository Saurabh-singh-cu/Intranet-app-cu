...
const RegisterNewEntity = () => {
  ...
  //     Swal.fire({
  //       title: "Error",
  //       text: "Please acknowledge the form submission by checking the box.",
  //       icon: "error",
  ...
  const validateAdvisoryBoardStudent = () => {
    const requiredFields = [
      "student_sec_1_name",
      "student_sec_1_email",
      "student_sec_1_uid",
    ...
    if (missingFields.length > 0) {
      Swal.fire({
        title: "Validation Error",
        text: `Please fill in at least the first Student Secretary details: ${missingFields.join(
          ", "
        )}`,
        icon: "error",
        confirmButtonText: "OK",
  ...
  const validateAdvisoryBoardFaculty = () => {
    const requiredFields = [
      "faculty_adv_1_name",
      "faculty_adv_1_email",
      "faculty_adv_1_empcode",
    ...
    if (missingFields.length > 0) {
      Swal.fire({
        title: "Validation Error",
        text: `Please fill in at least the first Faculty Advisor details: ${missingFields.join(
          ", "
        )}`,
        icon: "error",
        confirmButtonText: "OK",
  ...
  return (
    <div className="registration-container">
      <div style={{ width: "85vw" }} className="border-line">
        <aside style={{ padding: "2rem" }} className="sidebar-joinnow">
        ...
        <main style={{ overflow: "scroll" }} className="main-content">
                  ...
                  <div className="radio-group">
                    {[
                      ...
                      <button
                        ...
                        key={nature}
                        className={`radio-button ${
                          formData.entity_nature === nature ? "active" : ""
                        }`}
                        onClick={() =>
                          handleInputChange({
                  ...
                  <div className="radio-group">
                    {["STUDENT", "FACULTY"].map((proposer) => (
                      <button
                        ...
                        key={proposer}
                        className={`radio-button ${
                          formData.proposed_by === proposer ? "active" : ""
                        }`}
                        onClick={() =>
                          handleInputChange({
                  ...
                  <div key={`student_sec_${num}`} className="form-row">
                    <div className="form-group">
                      <label
                        ...
                        htmlFor={`student_sec_${num}_name`}
                      >
                        Student Secretary Name {num}
                      </label>
                      <input
                        className="form-input"
                        type="text"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`student_sec_${num}_email`}
                      >
                        Student Secretary Email {num}
                      </label>
                      <input
                        className="form-input"
                        type="email"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`student_sec_${num}_uid`}
                      >
                        Student Secretary UID {num}
                      </label>
                      <input
                        className="form-input"
                        type="text"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`student_sec_${num}_mobile`}
                      >
                        Student Secretary Mobile {num}
                      </label>
                      <input
                        className="form-input"
                        type="tel"
                ...
                {["1", "2"].map((num) => (
                  <div key={`student_advsec_${num}`} className="form-row">
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`student_advsec_${num}_name`}
                      >
                        Student Advisory Name {num}
                      </label>
                      <input
                        className="form-input"
                        type="text"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`student_advsec_${num}_email`}
                      >
                        Student Advisory Email {num}
                      </label>
                      <input
                        className="form-input"
                        type="email"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`student_advsec_${num}_uid`}
                      >
                        Student Advisory UID {num}
                      </label>
                      <input
                        className="form-input"
                        type="text"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`student_advsec_${num}_mobile`}
                      >
                        Student Advisory Mobile {num}
                      </label>
                      <input
                        className="form-input"
                        type="tel"
                ...
                {["1", "2"].map((num) => (
                  <div key={`faculty_adv_${num}`} className="form-row">
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`faculty_adv_${num}_name`}
                      >
                        Faculty Advisor Name {num}
                      </label>
                      <input
                        className="form-input"
                        type="text"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`faculty_adv_${num}_email`}
                      >
                        Faculty Advisor Email {num}
                      </label>
                      <input
                        className="form-input"
                        type="email"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`faculty_adv_${num}_empcode`}
                      >
                        Faculty Advisor Emp Code {num}
                      </label>
                      <input
                        className="form-input"
                        type="text"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`faculty_adv_${num}_mobile`}
                      >
                        Faculty Advisor Mobile {num}
                      </label>
                      <input
                        className="form-input"
                        type="tel"
                ...
                {["1", "2"].map((num) => (
                  <div key={`faculty_coadv_${num}`} className="form-row">
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`faculty_coadv_${num}_name`}
                      >
                        Faculty Co-Advisor Name {num}
                      </label>
                      <input
                        className="form-input"
                        type="text"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`faculty_coadv_${num}_email`}
                      >
                        Faculty Co-Advisor Email {num}
                      </label>
                      <input
                        className="form-input"
                        type="email"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`faculty_coadv_${num}_empcode`}
                      >
                        Faculty Co-Advisor Emp Code {num}
                      </label>
                      <input
                        className="form-input"
                        type="text"
                    ...
                    <div className="form-group">
                      <label
                        className="form-label"
                        htmlFor={`faculty_coadv_${num}_mobile`}
                      >
                        Faculty Co-Advisor Mobile {num}
                      </label>
                      <input
                        className="form-input"
                        type="tel"
            ...
            {activeTab === "acknowledgement" && (
              <div className="acknowledgement-container">
                ...
                <p>
                  ...
                  understand that submitting false or misleading information may
                  result in the rejection of this proposal or other appropriate
                  actions.
                </p>
