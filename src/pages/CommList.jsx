...
const CommList = () => {
  ...
  const fetchSocieties = async () => {
    try {
      const response = await fetch('http://172.17.2.176:8080/intranetapp/entity-registration-summary/?entity_id=4');
    ...
    <div className="dashboard-club">
      ...
      <main className="main-content-club">
        <div className="stats-container-club">
          <div className="stat-card-club-com">
            <div className="stat-number-club">4000+</div>
            <div className="stat-label-club">Active members</div>
          </div>
          <div className="stat-card-club-com">
            <div className="stat-number-club">{filteredSocieties?.length}</div>
            <div className="stat-label-club">Communities</div>
          </div>
          <div className="stat-card-club-com">
            <div className="stat-number-club">11</div>
            <div className="stat-label-club">Event organizers</div>
          </div>
          <div className="stat-card-club-com">
            <div className="stat-number-club">3</div>
            <div className="stat-label-club">Ongoing Events </div>
          </div>
        </div>

        <div className="communities-card-com">
          <h2 style={{ fontSize: "24px", marginBottom: "12px" }}>
            Communities
          </h2>
          <p style={{ opacity: 0.9 }}>
            Discover a world of opportunities through our vibrant communities
        ...
        <div className="societies-grid">
          {filteredSocieties.map((society, index) => (
            <div key={index} className="society-card">
              ...
              <button className="join-button-com" onClick={() => handleJoinNow(society)}>Read More</button>
            </div>
          ))}
        </div>
        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <button onClick={redirectJoinNow} type="submit" className="join-button-com">Join</button>
